...
**TELia** é um projeto de código aberto para criar um assistente de IA pessoal e inteligente diretamente no seu Telegram. Utilizando a simplicidade do **n8n** e o poder do **Google Gemini**, este bot pode ser configurado em minutos e com **custo absolutamente zero**.

### 💡 A Filosofia: Simplicidade e Custo Zero
